<template>
    <div class="inner_router centered">
        ...
        <p class="left">
            &nbsp;&nbsp;&nbsp;&nbsp;该技术广泛应用于小分子发现的早期过程中。通过分子对接软件模拟靶点受体蛋白质与多个化合物配体之间进行相互作用，计算两者之间的亲和力大小，从而预测潜在结合的小分子。虚拟筛选技术已经成为当今药物研发的重要手段，它能大大缩减传统实验筛选带来的财力、精力、时间上的消耗。<br/></br> &nbsp;&nbsp;&nbsp;&nbsp;本公司已经构建多个小分子化合物数据库，包含数百万个小分子，运用多种分子对接软件，可以快速实现寻找潜在先导化合物。</br></br>
        </p>
        <div class="centered">         
